...
char* pBANST[] = {
    "banestrike",
    "[ON/OFF]?",
    "${If[${Me.AltAbility[Banestrike]},1,0]}",
    "${If[${meleemvi[plugin]} && ${Me.AltAbility[Banestrike]},1,0]}",
};
...
char* pSENSE[] = {
    ...
    "[ON/OFF]?",
    "0",
    "${If[${meleemvi[plugin]} && ${Me.Skill[sense traps]},1,0]}",
};
...
char* pYAULP[] = {
    ...
    "${If[${meleemvi[plugin]} && ${Me.AltAbility[yaulp]},1,0]}",
};
...
void Configure() {
    ...
    switch (Class) {
    case  Warrior: // WAR
        AbilityFind(&idPROVOKE[1], &prowar43, &prowar42, &prowar41, &prowar40, &prowar39, &prowar38, &prowar37, &prowar36, &prowar35, &prowar34, &prowar33, &prowar32, &prowar31, &prowar30, &prowar29, &prowar28, &prowar27, &prowar26, &prowar25, &prowar24, &prowar23, &prowar22, &prowar21, &prowar20, &prowar19, &prowar18, &prowar17, &prowar16, &prowar15, &prowar14, &prowar13, &prowar12, &prowar11, &prowar10, &prowar9, &prowar8, &prowar7, &prowar6, &prowar5, &prowar4, &prowar3, &prowar2, &prowar1, 0);
        AbilityFind(&idOPPORTUNISTICSTRIKE, &opstrke12, &opstrke11, &opstrke10, &opstrke9, &opstrke8, &opstrke7, &opstrke6, &opstrke5, &opstrke4, &opstrke3, &opstrke2, &opstrke1, 0);
        AbilityFind(&idFIELDARM, &fieldarm15, &fieldarm14, &fieldarm13, &fieldarm12, &fieldarm11, &fieldarm10, &fieldarm9, &fieldarm8, &fieldarm7, &fieldarm6, &fieldarm5, &fieldarm4, &fieldarm3, &fieldarm2, &fieldarm1, 0);
        AbilityFind(&idDEFENSE, &defense15, &defense14, &defense13, &defense12, &defense11, &defense10, &defense9, &defense8, &defense7, &defense6, &defense5, &defense4, &defense3, &defense2, &defense1, 0);
    ...
    case Cleric: // CLR
        ...
        break;
    case  Paladin: // PAL
        AbilityFind(&idCHALLENGEFOR, &honor21, &honor20, &honor19, &honor18, &honor17, &honor16, &honor15, &honor14, &honor13, &honor12, &honor11, &honor10, &honor9, &honor8, &honor7, &honor6, &honor5, &honor4, &honor3, &honor2, &honor1, 0);
        AbilityFind(&idPROVOKE[0], &stunaas3, &stunaas2, &stunaas1, 0);
        AbilityFind(&idPROVOKE[1], &stunpal46, &stunpal45, &stunpal44, &stunpal43, &stunpal42, &stunpal41, &stunpal40, &stunpal39, &stunpal38, &stunpal37, &stunpal36, &stunpal35, &stunpal34, &stunpal33, &stunpal32, &stunpal31, &stunpal30, &stunpal29, &stunpal28, &stunpal27, &stunpal26, &stunpal25, &stunpal24, &stunpal23, &stunpal22, &stunpal21, &stunpal20, &stunpal19, &stunpal18, &stunpal17, &stunpal16, &stunpal15, &stunpal14, &stunpal13, &stunpal12, &stunpal11, &stunpal10, &stunpal9, &stunpal8, &stunpal7, &stunpal6, &stunpal5, &stunpal4, &stunpal3, &stunpal2, &stunpal1, 0);
        AbilityFind(&idSTEELY, &steely15, &steely14, &steely13, &steely12, &steely11, &steely10, &steely9, &steely8, &steely7, &steely6, &steely5, &steely4, &steely3, &steely2, &steely1, 0);
        AbilityFind(&idSTUN[0], &stunaas3, &stunaas2, &stunaas1, 0);
        AbilityFind(&idSTUN[1], &stunpal46, &stunpal45, &stunpal44, &stunpal43, &stunpal42, &stunpal41, &stunpal40, &stunpal39, &stunpal38, &stunpal37, &stunpal36, &stunpal35, &stunpal34, &stunpal33, &stunpal32, &stunpal31, &stunpal30, &stunpal29, &stunpal28, &stunpal27, &stunpal26, &stunpal25, &stunpal24, &stunpal23, &stunpal22, &stunpal21, &stunpal20, &stunpal19, &stunpal18, &stunpal17, &stunpal16, &stunpal15, &stunpal14, &stunpal13, &stunpal12, &stunpal11, &stunpal10, &stunpal9, &stunpal8, &stunpal7, &stunpal6, &stunpal5, &stunpal4, &stunpal3, &stunpal2, &stunpal1, 0);
        ...
        AbilityFind(&idRIGHTIND, &rightidg9, &rightidg8, &rightidg7, &rightidg6, &rightidg5, &rightidg4, &rightidg3, &rightidg2, &rightidg1, 0);
        break;
    case  Ranger: // RNG
        AbilityFind(&idJOLT, &joltrng2, &joltrng1, 0);
        AbilityFind(&idJLTKICKS, &jltkicks21, &jltkicks20, &jltkicks19, &jltkicks18, &jltkicks17, &jltkicks16, &jltkicks15, &jltkicks14, &jltkicks13, &jltkicks12, &jltkicks11, &jltkicks10, &jltkicks9, &jltkicks8, &jltkicks7, &jltkicks6, &jltkicks5, &jltkicks4, &jltkicks3, &jltkicks2, &jltkicks1, 0);
        AbilityFind(&idENRAGINGKICK, &enragingkick9, &enragingkick8, &enragingkick7, &enragingkick6, &enragingkick5, &enragingkick4, &enragingkick3, &enragingkick2, &enragingkick1, 0);
    ...
    case  Shadowknight: // SHD
        ...
        AbilityFind(&idGBLADE, &gblade9, &gblade8, &gblade7, &gblade6, &gblade5, &gblade4, &gblade3, &gblade2, &gblade1, 0); 
        AbilityFind(&idPROVOKE[1], &terror27, &terror26, &terror25, &terror24, &terror23, &terror22, &terror21, &terror20, &terror19, &terror18, &terror17, &terror16, &terror15, &terror14, &terror13, &terror12, &terror11, &terror10, &terror9, &terror8, &terror7, &terror6, &terror5, &terror4, &terror3, &terror2, &terror1, 0);
        AbilityFind(&idCHALLENGEFOR, &power21, &power20, &power19, &power18, &power17, &power16, &power15, &power14, &power13, &power12, &power11, &power10, &power9, &power8, &power7, &power6, &power5, &power4, &power3, &power2, &power1, 0);
        AbilityFind(&idSTEELY, &steely15, &steely14, &steely13, &steely12, &steely11, &steely10, &steely9, &steely8, &steely7, &steely6, &steely5, &steely4, &steely3, &steely2, &steely1, 0);
        AbilityFind(&idWITHSTAND, &withstand15, &withstand14, &withstand13, &withstand12, &withstand11, &withstand10, &withstand9, &withstand8, &withstand7, &withstand6, &withstand5, &withstand4, &withstand3, &withstand2, &withstand1, 0);
        break;
    case  Monk: // MNK
        ...
        AbilityFind(&idLEOPARDCLAW, &leop23, &leop22, &leop21, &leop20, &leop19, &leop18, &leop17, &leop16, &leop15, &leop14, &leop13, &leop12, &leop11, &leop10, &leop9, &leop8, &leop7, &leop6, &leop5, &leop4, &leop3, &leop2, &leop1, 0);
        ...
        AbilityFind(&idSYNERGY, &synergy15, &synergy14, &synergy13, &synergy12, &synergy11, &synergy10, &synergy9, &synergy8, &synergy7, &synergy6, &synergy5, &synergy4, &synergy3, &synergy2, &synergy1, 0);
    ...
    case  Rogue: // ROG
        ...
        AbilityFind(&idSTRIKE, &strike25, &strike24, &strike23, &strike22, &strike21, &strike20, &strike19, &strike18, &strike17, &strike16, &strike15, &strike14, &strike13, &strike12, &strike11, &strike10, &strike9, &strike8, &strike7, &strike6, &strike5, &strike4, &strike3, &strike2, &strike1, 0);
        AbilityFind(&idKNIFEPLAY, &knifeplay3, &knifeplay2, &knifeplay1, 0);
        AbilityFind(&idBLEED, &bleed15, &bleed14, &bleed13, &bleed12, &bleed11, &bleed10, &bleed9, &bleed8, &bleed7, &bleed6, &bleed5, &bleed4, &bleed3, &bleed2, &bleed1, 0);
        AbilityFind(&idVIGDAGGER, &vigrog15, &vigrog14, &vigrog13, &vigrog12, &vigrog11, &vigrog10, &vigrog9, &vigrog8, &vigrog7, &vigrog6, &vigrog5, &vigrog4, &vigrog3, &vigrog2, &vigrog1, 0);
        AbilityFind(&idASSAULT, &assault15, &assault14, &assault13, &assault12, &assault11, &assault10, &assault9, &assault8, &assault7, &assault6, &assault5, &assault4, &assault3, &assault2, &assault1, 0);
        ...
        AbilityFind(&idJUGULAR, &jugular18, &jugular17, &jugular16, &jugular15, &jugular14, &jugular13, &jugular12, &jugular11, &jugular10, &jugular9, &jugular8, &jugular7, &jugular6, &jugular5, &jugular4, &jugular3, &jugular2, &jugular1, 0);
    ...
    case Berserker: // BER
        BerserkerClass = true;
        AbilityFind(&idSLAPFACE, &slapface12, &slapface11, &slapface10, &slapface9, &slapface8, &slapface7, &slapface6, &slapface5, &slapface4, &slapface3, &slapface2, &slapface1, 0);
        AbilityFind(&idJOLT, &joltber25, &joltber24, &joltber23, &joltber22, &joltber21, &joltber20, &joltber19, &joltber18, &joltber17, &joltber16, &joltber15, &joltber14, &joltber13, &joltber12, &joltber11, &joltber10, &joltber9, &joltber8, &joltber7, &joltber6, &joltber5, &joltber4, &joltber3, &joltber2, &joltber1, 0);
        AbilityFind(&idRAGEVOLLEY, &volley26, &volley25, &volley24, &volley23, &volley22, &volley21, &volley20, &volley19, &volley18, &volley17, &volley16, &volley15, &volley14, &volley13, &volley12, &volley11, &volley10, &volley9, &volley8, &volley7, &volley6, &volley5, &volley4, &volley3, &volley2, &volley1, 0);
        ...
        AbilityFind(&idSTUN[1], &stunber25, &stunber24, &stunber23, &stunber22, &stunber21, &stunber20, &stunber19, &stunber18, &stunber17, &stunber16, &stunber15, &stunber14, &stunber13, &stunber12, &stunber11, &stunber10, &stunber9, &stunber8, &stunber7, &stunber6, &stunber5, &stunber4, &stunber3, &stunber2, &stunber1, 0);
        AbilityFind(&idCRIPPLE, &cripple25, &cripple24, &cripple23, &cripple22, &cripple21, &cripple20, &cripple19, &cripple18, &cripple17, &cripple16, &cripple15, &cripple14, &cripple13, &cripple12, &cripple11, &cripple10, &cripple9, &cripple8, &cripple7, &cripple6, &cripple5, &cripple4, &cripple3, &cripple2, &cripple1, 0);
        AbilityFind(&idCRYHAVOC, &cryhavoc4, &cryhavoc3, &cryhavoc2, &cryhavoc1, 0);
        AbilityFind(&idBLOODLUST, &bloodlust15, &bloodlust14, &bloodlust13, &bloodlust12, &bloodlust11, &bloodlust10, &bloodlust9, &bloodlust8, &bloodlust7, &bloodlust6, &bloodlust5, &bloodlust4, &bloodlust3, &bloodlust2, &bloodlust1, 0);
        AbilityFind(&idVIGAXE, &vigber15, &vigber14, &vigber13, &vigber12, &vigber11, &vigber10, &vigber9, &vigber8, &vigber7, &vigber6, &vigber5, &vigber4, &vigber3, &vigber2, &vigber1, 0);
        AbilityFind(&idOPFRENZY, &opfrenzy15, &opfrenzy14, &opfrenzy13, &opfrenzy12, &opfrenzy11, &opfrenzy10, &opfrenzy9, &opfrenzy8, &opfrenzy7, &opfrenzy6, &opfrenzy5, &opfrenzy4, &opfrenzy3, &opfrenzy2, &opfrenzy1, 0);
        AbilityFind(&idRALLOS, &rallos15, &rallos14, &rallos13, &rallos12, &rallos11, &rallos10, &rallos9, &rallos8, &rallos7, &rallos6, &rallos5, &rallos4, &rallos3, &rallos2, &rallos1, 0);
        break;
    }
...
PLUGIN_API void InitializePlugin()
{
    ...
    MapInsert(&CmdListe, Option(pBANST[0], pBANST[1], pBANST[2], pBANST[3], NULL, &doBANESTRIKE));
